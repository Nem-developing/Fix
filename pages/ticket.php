                        ...
                        if ($lignedeux->technicien == "N/A") {
                            ...
                            $bouton = "<form action='../actions/archiver.php?id=$id' method='post'>
                                                <div class='form-group'>
                                                    <label for='exampleFormControlInput1' class='titrecommentaire'>Commentaire d'archivage du ticket :</label>
                                                    <textarea class='form-control bg-dark text-white commentaire' name='commentaire' id='exampleFormControlTextarea1' rows='12' placeholder='Exemple : Problème résolu ! | Commandes bien ajoutées : /unecommande ; /unedeuxièmecommande.' required></textarea>
                                                </div>
