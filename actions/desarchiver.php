...
<html lang="en">
    ...
    <body>
        ...
        <div id="page">
            ...
            if (!$mysqli->query("UPDATE `tickets` SET `etat` = '0', `heure` = '$heure',`date` = '$date',`datepec` = 'N/A', `datefin` = 'N/A',`heurepec` = 'N/A', `heurefin` = 'N/A', `technicien` = 'N/A', `commentaire` = 'N/A' WHERE `id` = '$id'")) {
