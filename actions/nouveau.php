...
<html lang="en">
    ...
    <body>
        ...
        <div id="page">
            ...
            if (!$mysqli->query("INSERT INTO `tickets` (`serveur`, `sujetprincipal`, `description`, `date`, `heure`, `datepec`, `heurepec`,  `datefin`, `heurefin`,  `urgence`, `etat`, `ip`, `technicien`) VALUES ('$serveurok', '$sujetprincipalok', '$descriptionok', '$date', '$heure', 'N/A', 'N/A','N/A','N/A', '$urgence', '0', '$ip', 'N/A');")) {
